...
<body>
            ...
            <aside class="sidebar">
                ...
                <nav>
                    <ul class="menu">
                        ...
                        <a href="./schedule.php" class="menu-item active"><span class="menu-icon">📅</span> Schedule</a>
    ...
    <button class="calendar-button" onclick="window.location.href='calendar/calendar.html'">View Full Calendar</button>
